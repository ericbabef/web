...
$pg_title = "RDM";
$pg_subtitle = "Ajouter un établissement";
...
$pg_content = <<<CONTENT
<form action="index.php?action=add" name="frm" id="frm" method="post" enctype="multipart/form-data" class="form-horizontal">
    <div class="row">
        <div class="col-md-6">
...
CONTENT;
                                foreach($type_rdm_fetch as $row) {
                                    $pg_content .= '<option value="'.$row['id'].'">'.$row['name'].'</option>';
                                }
$pg_content .= <<<CONTENT
                            </select>
                        </div>
                    ...
                    <textarea name="desc" class="form-control" id="desc" rows="4" placeholder="Description ..."></textarea>
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="overview alert alert-info">
                        ...
                        Pour localiser un établissement, vous devez rechercher une adresse, puis cliquer sur l'adresse souhaitée. Un marker apparaitra sur la carte. Il est possible de déplacer ce marker pour davantage de présicion.
                    </div>
...
$pg_content .= <<<CONTENT
    <div class="row">
        ...
        <div class="col-md-6">
            <button type="submit" id="frm_Submit" class="btn btn-primary btn-social btn-lg pull-right"><i class="fa fa-plus-circle"></i> Ajouter</button>
        </div><!-- /.col -->
    </div><!-- /.row -->
</form>
CONTENT;
